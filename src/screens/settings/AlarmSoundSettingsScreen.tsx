...
const styles = StyleSheet.create({
  ...
  toggleRow: { flexDirection: 'row', marginTop: 10, gap: 4, backgroundColor: '#F0F0F1', borderRadius: 14, padding: 4 },
  toggleButton: {
    flex: 1,
    alignItems: 'center',
    borderRadius: 11,
  ...
  toggleButtonActive: { backgroundColor: '#FFCE0C' },
  toggleButtonText: { color: '#8A8A8E', fontSize: 13, fontWeight: '600' },
  toggleButtonTextActive: { color: '#1A1A1A', fontWeight: '700' },
});
